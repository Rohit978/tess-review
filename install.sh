...
# 4. Prompt for OpenRouter API Key
echo ""
echo "-------------------------------------------"
...
if [ -n "$user_api_key" ]; then
    ...
    echo "✅ Successfully added OPENROUTER_API_KEY to $shell_config"
fi
...
if [ -n "$shell_config" ]; then
    ...
    echo "Please set up your OpenRouter API Key manually if you skipped it:"
